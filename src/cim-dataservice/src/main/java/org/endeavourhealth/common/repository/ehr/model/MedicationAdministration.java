...
public class MedicationAdministration {
	private UUID medicationAdministrationId;
	...
	public UUID getMedicationAdministrationId() {
		return medicationAdministrationId;
	}
	public void setMedicationAdministrationId(UUID medicationAdministrationId) {
