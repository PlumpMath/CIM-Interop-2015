...
@XmlSeeAlso({
    org.endeavourhealth.cim.transform.schemas.openhr.OpenHR001Referral.Speciality.class,
    OpenHR001LocationType.class,
    DtCodeQualified.class,
    org.endeavourhealth.cim.transform.schemas.openhr.OpenHR001Organisation.Speciality.class
})
public class DtCode {
