	...
	var DataTable = function( oInit )
	{
		...
		function _fnGetObjectDataFn( mSource )
		{
			...
			else if ( typeof mSource === 'string' && (mSource.indexOf('.') !== -1 || mSource.indexOf('[') !== -1) )
			{
				 ...
				 * level down. On each loop we resources for undefined, and if found immediately
		...
		function _fnSort ( oSettings, bApplyClasses )
		{
				...
				(oSettings.aaSorting.length !== 0 || oSettings.aaSortingFixed !== null) )
			{
				 ...
				 *  }
				 * Basically we have a resources for each sorting column, if the data in that column is equal,
				 * resources the next column. If all columns match, then we use a numeric sort on the row
		 ...
		 *      oTable.fnFilter( 'resources string' );
		 *    } );
		 */
